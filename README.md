...
<img width="400" height="400" alt="image" src="https://github.com/user-attachments/assets/e2419c80-5ac7-4ee2-92b3-5eba488abffd" />
...
La gráfica representa la trayectoria latido a latido del Índice Pletismográfico Quirúrgico ($SPI$) en función del tiempo ($t$), evaluando la respuesta combinada de la amplitud de pulso y el intervalo inter-latido ante la activación simpática. En el trazado se aprecia que durante la fase basal ($0 - 40\text{ s}$) el índice fluctúa en una franja baja entre $20$ y $40$ unidades; al iniciar el CPT ($40 - 80\text{ s}$), se evidencia claramente cómo el SPI sube de forma pronunciada hasta consolidar una meseta entre $50$ y $65$ unidades, y finalmente, al cesar el estímulo ($80 - 120\text{ s}$), la curva vuelve a bajar progresivamente hacia valores de $25 - 32$ unidades, registrando únicamente un artefacto puntual máximo de $100$ cerca del segundo $86$.
